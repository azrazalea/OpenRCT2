...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        // Window: AIAgentTerminal
        STR_AGENT_TERMINAL_TITLE = 7008,
        STR_AGENT_FOLLOW_BUTTON_TIP = 8000,
        STR_AGENT_FOLLOW_STATUS_ON = 8001,
        STR_AGENT_FOLLOW_STATUS_OFF = 8002,
        STR_AGENT_MINIMIZE_BUTTON_TIP = 8003,
        STR_AGENT_MAXIMIZE_BUTTON_TIP = 8004,
        STR_AGENT_AUTOPLAY_BUTTON_TIP = 8005,
        STR_AGENT_AUTOPLAY_STATUS_ON = 8006,
        STR_AGENT_AUTOPLAY_STATUS_OFF = 8007,
        STR_AGENT_SCROLL_LOCK_BUTTON_TIP = 8008,
